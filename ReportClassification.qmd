...
-   Still, the Arsenal ensemble also achieved a comparable log loss score, which is very impressive for a fairly simple method. Also keep in mind that we can combine a ROCKET transformation with any classifier in theory, instead of just logistic regression.
